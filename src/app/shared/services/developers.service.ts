...
export class DevelopersService {
  ...
  public uploadProjectLogo(id: number, image: string | ArrayBuffer): Observable<string> {
    return this.http.post<string>(`${this.apiUrl}accounts/upload-project-logo`, {id, image});
  }
}
