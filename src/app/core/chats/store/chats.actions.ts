...
export const updateConversationsListSuccess = createAction('[Chat] Update conversations list success', (convs: ConversationModel[]) => ({ convs }));
...
export const searchConversationsSuccess = createAction('[Chat] Search conversations success', (convs: ConversationModel[]) => ({ convs }));
...
export const getConverastionMessagesSuccess = createAction('[Chat] Get conversation messages success', (messages: ConversationMessageModel[]) => ({ messages }));
export const getConverastionMessageError = createAction('[Chat] Get conversation messages error', (err: any) => err);

// New message
export const addNewMessage = createAction('[Chat] Add new message', props<ConversationMessageModel>());
...
export const createNewConversation = createAction('[Chat] Create new conversation success', props<{ conv: ConversationModel, open: boolean }>());
